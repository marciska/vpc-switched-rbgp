...
hold(ax2,'on')
plot3(ax2,X1_(:,1) - 2,X1_(:,2),X1_(:,3),'Color','#e63946','LineWidth',lw);
xlim(ax2,[-2.1 2.1]);
ylim(ax2,[-3.3 3.3]);
ax2.FontSize = 25;
...
hold(ax3,'on')
plot3(ax3,X2_(:,1) - 2,X2_(:,2),X2_(:,3),'Color','#e63946','LineWidth',lw);
xlim(ax3,[-2.1 2.1]);
ylim(ax3,[-3.3 3.3]);
ax3.FontSize = 25;
...
ax1 = nexttile;
hold(ax1,'on')
traj_v = plot3(ax1,X1_(:,1) - 2,X1_(:,2),X1_(:,3),'Color','#457b9d','LineWidth',lw);
traj_q = plot3(ax1,X2_(:,1) - 2,X2_(:,2),X2_(:,3),'Color','#38b000','LineWidth',lw);
data_v = plot3(ax1,X1(:,1) - 2,X1(:,2),X1(:,3),'x','Color','#e63946','MarkerSize',ms,'LineWidth',mw);
data_q = plot3(ax1,X2(:,1) - 2,X2(:,2),X2(:,3),'x','Color','#fb8500','MarkerSize',ms,'LineWidth',mw);
ax1.FontSize = 30;
grid(ax1,'on')
xlim([-2.5, 2.5])
ylim([-3.5, 3.5])
...
ax = gca;
hold(ax,'on')
traj_v = plot3(ax,X1_(:,1),X1_(:,2),X1_(:,3),'Color','#457b9d','LineWidth',3);
traj_q = plot3(ax,X2_(:,1),X2_(:,2),X2_(:,3),'Color','#38b000','LineWidth',3);
data_v = plot3(ax,X1(:,1),X1(:,2),X1(:,3),'x','Color','#e63946','MarkerSize',10,'LineWidth',3);
data_q = plot3(ax,X2(:,1),X2(:,2),X2(:,3),'x','Color','#fb8500','MarkerSize',10,'LineWidth',3);
animate(ax,out.tout,...
